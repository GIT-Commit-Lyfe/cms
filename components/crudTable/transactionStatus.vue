<template>
  <v-data-table :headers="headers" :items="items" class="elevation-1">
    <template v-slot:top>
      <v-toolbar flat>
        <v-toolbar-title>Transaction Status Table</v-toolbar-title>
...
export default {
  data: () => ({
    dialog: false,
    dialogDelete: false,
    statusOption: ['done', 'shipping', 'verification', 'paid', 'pending'],
  ...
  computed: {
    formTitle() {
      return this.editedIndex === -1 ? `Add Transaction Status` : `Edit Transaction Status`
    },
  },
